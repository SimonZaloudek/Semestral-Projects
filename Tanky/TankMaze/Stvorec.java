...
public class Stvorec {
    ...
    public boolean obsahujeSuradnice(int x, int y) {
        return x >= this.lavyHornyX && x < this.lavyHornyX + strana && y >= this.lavyHornyY && y < this.lavyHornyY + strana;
    }
    ...
    /**
     * (tvorec) Posuň sa pomaly vodorovne o dĺžku danú parametrom.
     *
    ...
    */
    ...
    //AnimacneCakanie
    public void waitMetoda(int dlzka) {
        Platno.dajPlatno().wait(dlzka);
    }
